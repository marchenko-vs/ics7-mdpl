...
main proc
    ...
    Dialog "Calculator","MS Sans Serif",12, \         ; caption,font,pointsize
            WS_OVERLAPPED or WS_SYSMENU or DS_CENTER, \     ; style
            4, \                                            ; control count
            50,50,150,70, \                                 ; x y co-ordinates
            1024                                            ; memory buffer size

    DlgButton "Calculate",WS_TABSTOP,55,10,40,10,IDOK
    DlgButton "Exit",WS_TABSTOP,55,25,40,10,IDCANCEL
    DlgStatic 'Click on "Calculate" to sum two digits',SS_CENTER,3,40,140,9,100
...
dlgproc proc hWin:DWORD,uMsg:DWORD,wParam:DWORD,lParam:DWORD
    ...
    .elseif uMsg == WM_COMMAND
      .if wParam == IDOK
        ...
        jmp nxt
      @@:
        invoke MessageBox,hWin,SADD("You did not enter an experssion"),
                               SADD("No result"),MB_OK
      nxt:
...
GetText proc hParent:DWORD,lpIcon:DWORD,buffer:DWORD
    ...
    Dialog "Enter an expression","MS Sans Serif",10, \               ; caption,font,pointsize
            WS_OVERLAPPED or WS_SYSMENU or DS_CENTER, \     ; style
            4, \                                            ; control count
